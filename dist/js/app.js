...
},{"./app.vue":44,"babel-runtime/helpers/extends":3,"vue":42}],44:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./components/TestComponent.vue":45,"vue":42,"vue-hot-reload-api":41}],45:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"test-component"},[_c('p',[_vm._v(_vm._s(_vm.class_name))])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-28db1446", __vue__options__)
  } else {
    hotAPI.reload("data-v-28db1446", __vue__options__)
  }
})()}

},{"../modules/TestModule.js":46,"vue":42,"vue-hot-reload-api":41}],46:[function(require,module,exports){
'use strict';
